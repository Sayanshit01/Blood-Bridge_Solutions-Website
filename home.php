...
<head>
  ...
  <link rel="import" href="https://fonts.googleapis.com/css2?family=Baskervville+SC&display=swap">
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image/banner1.webp" alt="image\_107317099_blooddonor976.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image/first.jpg" alt="banner" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image/banner2.jpg" alt="image" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image/banner3.jpg" alt="image" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image/banner4.webp" alt="image" width="100%" height="500">
      </div>
    </div>
...
<br>
<div class="new">
        <h1 style="text-align:center;font-size:45px;">Welcome to BloodBridge Solutions</h1></div>
<br>
        <div class="row">
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="image/bdlogo1.png" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image/home1.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
    ...
    <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" 
       style="align:center; background-color:#ff867c;color:#273746; transition: background-color 0.3s, color 0.3s;"
       onmouseover="this.style.backgroundColor='#ffeaac'; this.style.color='#273746';" 
       onmouseout="this.style.backgroundColor='#ff867c'; this.style.color='#273746';">
        Become a Donor
    </a>
</div>
        </div>
